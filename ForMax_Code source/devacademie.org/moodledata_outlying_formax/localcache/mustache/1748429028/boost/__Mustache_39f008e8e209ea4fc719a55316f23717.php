...
class __Mustache_39f008e8e209ea4fc719a55316f23717 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section9dcc654fc072ec9fbe6883432f36fb4e($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function section9dcc654fc072ec9fbe6883432f36fb4e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
