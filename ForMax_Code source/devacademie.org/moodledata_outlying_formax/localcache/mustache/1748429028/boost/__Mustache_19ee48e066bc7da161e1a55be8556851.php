...
class __Mustache_19ee48e066bc7da161e1a55be8556851 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section363c3dffdbc94eb932adeb55228a23b8($context, $indent, $value);
        $buffer .= $indent . '            </tbody>
';
        $buffer .= $indent . '        </table>
';
...
';
    ...
    private function sectionAf8891310c2fa6d0a41f012e9c333139(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                <td class="text-start">
';
...
';
    ...
    private function section1e3d4eccc620a706127722d961fcb650(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionAf8891310c2fa6d0a41f012e9c333139($context, $indent, $value);
                $buffer .= $indent . '                        </tr>
';
                $context->pop();
            }
    ...
    private function section363c3dffdbc94eb932adeb55228a23b8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section1e3d4eccc620a706127722d961fcb650($context, $indent, $value);
                $context->pop();
            }
        }
