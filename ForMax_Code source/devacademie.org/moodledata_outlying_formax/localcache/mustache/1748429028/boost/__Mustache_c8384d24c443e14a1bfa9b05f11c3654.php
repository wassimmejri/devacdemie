...
class __Mustache_c8384d24c443e14a1bfa9b05f11c3654 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF19be6b906148d6b6b0aa49df2dce62b($context, $indent, $value);
        $value = $context->find('previoussubmission');
        $buffer .= $this->sectionF19be6b906148d6b6b0aa49df2dce62b($context, $indent, $value);
        $value = $context->find('edit');
        $buffer .= $this->sectionC6563f6dfad43ebaebee276297ee96d1($context, $indent, $value);
...
';
    ...
    private function sectionF19be6b906148d6b6b0aa49df2dce62b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="col-xs-6 me-3">
';
...
';
    ...
    private function sectionC6563f6dfad43ebaebee276297ee96d1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
