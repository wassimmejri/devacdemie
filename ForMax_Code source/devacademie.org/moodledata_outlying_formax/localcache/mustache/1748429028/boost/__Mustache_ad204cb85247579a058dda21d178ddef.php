...
class __Mustache_ad204cb85247579a058dda21d178ddef extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section3d26ccb3ffd90a42522300f1c4b05854($context, $indent, $value);
        $value = $context->find('haschildren');
        if (empty($value)) {
...
';
            ...
            $buffer .= $this->section56ffecc97f3d4b7ec56613815b03c3b3($context, $indent, $value);
            $value = $context->find('istablist');
            if (empty($value)) {
...
';
    ...
    private function section3d26ccb3ffd90a42522300f1c4b05854(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section56ffecc97f3d4b7ec56613815b03c3b3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
