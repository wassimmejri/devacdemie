...
class __Mustache_e6691e6b29a20bbe37f22b1a82ebec79 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9b0174cfd6bac3c0b71f9dd3cb4c528a($context, $indent, $value);
        $value = $context->findDot('state.hasdiscussions');
        if (empty($value)) {
...
';
    ...
    private function sectionB056ce1322aa5a66fdd7c95ac48b5d4c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0cee6d39fabde043da83aa95f3987d57(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '" class="badge bg-primary text-white rounded-pill font-weight-normal"
';
                $buffer .= $indent . '                                                       title="';
                $value = $context->find('str');
...
';
    ...
    private function sectionD3d433016d6ef603886688790fefe42b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section0cee6d39fabde043da83aa95f3987d57($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section50c155f9e3acc5362cf046b84a5356c4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->findDot('forum.userstate.tracked');
                $buffer .= $this->sectionD3d433016d6ef603886688790fefe42b($context, $indent, $value);
                $buffer .= $indent . '                                    </td>
';
                $context->pop();
            }
...
';
    ...
    private function section0136cafa00c268d1ed873abbb5feeb8a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionB056ce1322aa5a66fdd7c95ac48b5d4c($context, $indent, $value);
                $buffer .= $indent . '                                        </div>
';
                $buffer .= $indent . '                                    </div>
';
...
';
                ...
                $buffer .= $this->section50c155f9e3acc5362cf046b84a5356c4($context, $indent, $value);
...
';
    ...
    private function section9b0174cfd6bac3c0b71f9dd3cb4c528a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                        ...
                        $buffer .= $this->section0136cafa00c268d1ed873abbb5feeb8a($context, $indent, $value);
                        $buffer .= $indent . '                    </tbody>
';
                    }
                    $buffer .= $indent . '                </table>
