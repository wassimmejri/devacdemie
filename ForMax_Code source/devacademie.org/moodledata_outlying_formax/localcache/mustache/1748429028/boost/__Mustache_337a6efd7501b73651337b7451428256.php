...
class __Mustache_337a6efd7501b73651337b7451428256 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</legend>
';
        $buffer .= $indent . '        <div class="border-radius my-2 p-2 bg-white border d-flex flex-column flex-md-row align-items-md-stretch mx-0 row">
';
...
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '                <select class="custom-select mb-1 mb-md-0 me-md-2" data-filterfield="join" id="core-filter_row-jointype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '            <select class="custom-select my-1 mb-md-0 me-md-2" data-filterfield="type" id="core-filter_row-filtertype-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div data-filterregion="joinadverb" class="ps-1 text-uppercase font-weight-bold">
';
