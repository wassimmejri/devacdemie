...
class __Mustache_480bc8e92414f03f9171cc62306ce81f extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <button data-filteraction="reset" type="button" class="btn btn-secondary ms-auto me-2">';
        $value = $context->find('str');
