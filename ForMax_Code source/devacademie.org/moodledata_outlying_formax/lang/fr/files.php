...
$string['redactor:exifremover:enabled_desc'] = 'Par défaut, le nettoyeur EXIF ne prend en charge les fichiers JPG qu’avec PHP gd, ce qui dégrade la qualité de l’image et supprime la balise d’orientation des images.
