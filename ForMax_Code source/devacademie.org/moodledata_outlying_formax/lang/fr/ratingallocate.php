...
/**
 * Strings for component 'ratingallocate', language 'fr', version '4.5'.
 *
...
$string['confirm_start_distribution'] = 'L’exécution de l’algorithme supprimera toutes les attributions existantes, le cas échéant. Voulez-vous vraiment continuer ?';
...
$string['invalid_publishdate'] = 'La date de publication est non valide. La date de publication doit être postérieure à la fin de la notation.';
