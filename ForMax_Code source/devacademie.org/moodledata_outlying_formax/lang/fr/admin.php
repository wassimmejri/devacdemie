...
$string['importantupdates_content'] = '<p>Dans la version 5.0 de Moodle, prévue pour avril 2025, les activités Chat et Consultation seront retirées du noyau de Moodle. Elles seront disponibles sous forme de plugins dans le <a href="https://moodle.org/plugins/">Répertoire des plugins Moodle</a>.</p>
<p>Si vous souhaitez continuer à utiliser Chat ou Consultation sur votre site, vous pourrez les installer en tant que plugins avant la mise à jour vers Moodle 5.0.</p>';
