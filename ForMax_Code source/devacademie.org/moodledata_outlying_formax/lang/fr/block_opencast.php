...
/**
 * Strings for component 'block_opencast', language 'fr', version '4.5'.
 *
...
$string['changevisibility_mixed'] = 'La visibilité de la vidéo est dans un état non valide. Cliquez pour choisir une visibilité correcte.';
...
$string['deleteeventdesc'] = 'Vous êtes sur le point de supprimer définitivement et de façon irréversible cette vidéo d’opencast.<br/>Tous les liens associés ne seront plus valides. Continuez cette action seulement si vous en êtes absolument sûr.';
...
$string['invalidacldata'] = 'Données d’ACL non valides';
...
$string['wrongmimetypedetected'] = 'Un type MIME non valide a été utilisé pendant le dépôt de la vidéo {$a->filename} depuis le cours {$a->coursename}.
