...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"200px"}}},"layout":{"contentSize":"1170px"}} -->
...
<!-- wp:search {"label":"Search...","showLabel":false,"width":75,"widthUnit":"%","buttonText":"Search","align":"center","style":{"border":{"radius":"10px","width":"0px","style":"none"}},"backgroundColor":"secondary","textColor":"white","className":"vorfolio-animate vorfolio-move-up vorfolio-delay-5"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></main>
