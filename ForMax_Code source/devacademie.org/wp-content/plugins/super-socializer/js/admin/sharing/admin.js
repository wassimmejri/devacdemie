...
"function" != typeof String.prototype.trim && (String.prototype.trim = function() {
    ...
    // rutube url option
    jQuery('input#the_champ_rutube').click(function(){
        if(jQuery(this).is(':checked')){
            jQuery('#the_champ_rutube_options').css('display', 'table-row-group');
        }else{
            jQuery('#the_champ_rutube_options').css('display', 'none');
        }
    });
    jQuery('input#the_champ_vertical_sharing_rutube').click(function(){
        if(jQuery(this).is(':checked')){
