...
function theme_boost_extend_context(\context $context, \renderer_base $output, \stdClass $page, array &$contextarray) {
    global $USER;

    if (isloggedin() && !isguestuser()) {
        $contextarray['username'] = $USER->username;
    } else {
        $contextarray['username'] = '';
    }
}
